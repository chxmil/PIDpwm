...
│   ├── Issue Report/           # Open issues and architectural concerns (one .md per issue)
│   ├── DevLog/                 # Change Report (When AI change something in code it must update here)
│   └── Update Report/          # Update Report (When Accept Change report in here it must update here)
│   
